-- Dropear la base de datos si existe (con conexiones activas forzadas)
IF EXISTS (SELECT * FROM sys.databases WHERE name = 'GRC_Assessment')
BEGIN
    ALTER DATABASE GRC_Assessment SET SINGLE_USER WITH ROLLBACK IMMEDIATE;
    DROP DATABASE GRC_Assessment;
    PRINT 'Base de datos anterior eliminada';
END
GO

-- Crear la base de datos nuevo
