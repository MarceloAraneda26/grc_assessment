...
import { calcularResultadoCyberLey, calcularRoadmapCyberLey } from './cyber-ley-scoring.js';
...
export const getDatosResultados = (evaluacion) => {
  ...
  return calcularResultadoCyberLey(evaluacion.modulo, evaluacion.perfil || {}, respuestas);
};
...
export const getDatosRoadmap = (evaluacion) => {
  ...
  return calcularRoadmapCyberLey(evaluacion.modulo, evaluacion.perfil || {}, respuestas);
};
